...
Math in desc should be presented as latex delimited with $$.
Numerical values are replaced by map entries in the object D, each represented as non-repeating strings of lowercase letters of minimal length surrounded by // on either side as delimiters.
