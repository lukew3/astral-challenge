...
Do not provide any other output. Each step description should briefly detail how to perform a step and contain a latex representation delimited with $$ where numerical values are replaced by map entries in the object D, each represented as unique letters a-z surrounded by // on either side as delimiters.
The code field should contain some javascript code to set the new map entries calculated from the variables in the previous step.
...
The last step should be the most simplified form of the answer.
I'll provide you with a partial example of the format I expect:
4x - 2 = 2
[{"desc": "$$//a//x - //b// = //c//$$", "code": "d['a'] = 4; d['b'] = 2; d['c'] = 2;"}, {"desc": "Add //b// to both sides: $$//a//x - //b// + //b// = //c// + //b//$$ $$//a//x = //e//$$", "code": "d['e'] = d['c'] + d['b'];"}, ...]
`;
